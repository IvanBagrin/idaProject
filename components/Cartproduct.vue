<template>
                ...
                <div class="cart__product_item">
                    <div class="cart__product_img"><img src="img/product/louisv.png" alt=""></div>
                    <div class="cart__product_descr">
                        <div class="cart__product_title">Рюкзак Louis Vuitton Discovery</div>
                        <div class="cart__product_price">150 000 ₽</div>
                        ...
                        <div class="cart__product_score">4.5</div>
                        </div>
