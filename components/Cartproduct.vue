                ...
                <div class="cart__product_item">
                    ...
                    <div class="cart__product_descr">
                        ...
                        <div class="cart__product_rating">
                            <div>
                        <div class="cart__item_body"></div>
                            <div class="cart__item_active" >
                                
                            </div>
                             
					<div class="cart__block" v-bind:style="{ height: this.$props.item.rating == 5?  8 + 'px' : 14 - this.$props.item.rating + 'px' }">
                        </div>
                    </div>
