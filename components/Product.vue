         ...
         <div class="product__item" :data-category ="this.$props.item.category">
            <div class="product__item_header">
                <div class="product__item_rating">
                    ...
                    <div>
                        <div class="product__item_body"></div>
                            <div class="product__item_active" >
                                
                            </div>
                             
					<div class="product__block" v-bind:style="{ height: this.$props.item.rating == 5?  8 + 'px' : 14 - this.$props.item.rating + 'px' }">
                        </div>
                    </div>
